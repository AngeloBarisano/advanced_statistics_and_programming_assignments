...
\begin{tikzpicture}
	...
	\node (4) at (2.15,2.5) {Zoning};
	\node (5) [right = of 1] {Years Since Remodeling};
	\node (6) [right = of 4] {LotArea};
	
	\coordinate (7) at (2.15,1.65);
	\path (4) edge node[left] {$?$} (7);
	
	\path (1) edge node[above] {$+$} (3);
	\path (5) edge node[right] {$+$} (3);
	
	\coordinate (8) at (2,0.75);
	\path (5) edge node[above] {$-$} (8);
	
	\path (2) edge node[below] {$+$} (3);
	\path (6) edge node[below] {$+$} (3);
\end{tikzpicture}
\end{center}
...
% Table created by stargazer v.5.2.3 by Marek Hlavac, Social Policy Institute. E-mail: marek.hlavac at gmail.com
% Date and time: Sat, Sep 10, 2022 - 23:06:26
\begin{table}[!htbp] \centering 
  \caption{} 
  \label{} 
...
% Table created by stargazer v.5.2.3 by Marek Hlavac, Social Policy Institute. E-mail: marek.hlavac at gmail.com
% Date and time: Sun, Sep 11, 2022 - 00:09:15
\begin{table}[!htbp] \centering 
  \caption{} 
  \label{} 
