...
only_broken_home <- subset(df_, MSZoning == "Moderate Density")

no_broken_home <- subset(df_, MSZoning == "Low Density")
...
full_model_sub2 <-
  lm(
    SalePrice ~ 1 + tot_liv_area  + y_since_rem    + y_since_rem * OverallQual ,
    data = only_broken_home
  )
full_model_sub3 <-
  lm(
    SalePrice ~ 1 + tot_liv_area  + y_since_rem    + y_since_rem * OverallQual ,
...
stargazer(full_model_sub, full_model_sub2, full_model_sub3, type = 'text')
