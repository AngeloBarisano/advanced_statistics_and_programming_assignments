...
df_$time_since_remodeling <- df_$YrSold - df_$YearRemodAdd
...
scatter + geom_point() + geom_smooth(method = "lm", aes(fill = "Building_type"), alpha = 0.1) + labs(x = 'Age of house at point of sale', y = "Sale Price")

scatter <- ggplot(df_, aes(time_since_remodeling, SalePrice))
scatter + geom_point() + geom_smooth(method = "lm", aes(fill = "Building_type"), alpha = 0.1) + labs(x = 'Age of house at point of sale', y = "Sale Price")

scatter <- ggplot(df_, aes(time_since_remodeling, SalePrice, colour = Neighborhood))
scatter + geom_point() + geom_smooth(method = "lm", aes(fill = "Neighborhood"), alpha = 0.1) + labs(x = 'Living space in square feet', y = "Sale Price", color = 'Neighborhood') 
